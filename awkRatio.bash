...
ratio=$(tail -1 /home/ncrdcs/Documents/testLOG.txt | awk '{print 100 * $17 / $11}')
alertBorderValue=50
result=$(echo "${ratio}>${alertBorderValue}" | bc)

if [ $result = 1 ]; then
	echo "[WARN]" $current_time": "$ratio >> /home/ncrdcs/Documents/testOUTPUT.txt
else
	echo "[INFO]" $current_time": "$ratio >> /home/ncrdcs/Documents/testOUTPUT.txt
fi
